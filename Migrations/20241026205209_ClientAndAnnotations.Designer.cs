...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241026205209_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8319),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8393),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8394),
                            ServicesID = 5
                        });
                });
