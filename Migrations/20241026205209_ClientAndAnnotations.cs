    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8319), 1 },
                    { 2, 2, new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8393), 7 },
                    { 3, 1, new DateTime(2024, 10, 26, 16, 52, 8, 968, DateTimeKind.Local).AddTicks(8394), 5 }
                });
